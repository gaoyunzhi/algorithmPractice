...
# state = (string of current word, previous path)
# startState = (the start word,  [])
# Endstate = (the end word, *)
# Action(state) = (change some alphabet restricted by the dictionary)
# Cost(state, action) = 1
# As the cost function is a constant, thus we can use a BFS to find an 
# optimal solution and its depth and see if there is other optimla path
